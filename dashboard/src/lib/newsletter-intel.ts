...
const SOURCE_DESCRIPTIONS: Record<string, string> = {
  ...
  hud_homestore: "Official HUD-owned REO inventory",
  homesteps: "Freddie Mac HomeSteps REO inventory",
  bank_of_america_reo: "Official Bank of America bank-owned inventory",
  homepath: "Fannie Mae HomePath inventory",
  linkedin_jobs: "LinkedIn guest job search for REO and servicing roles",
  indeed_jobs: "Indeed job search for REO and servicing roles",
  google_jobs: "Google Jobs-style web search signals for REO and default servicing roles",
  ziprecruiter_jobs: "ZipRecruiter job signal scraping for REO and servicing roles",
  company_career_jobs: "Direct company career-page hiring signals across banks and servicers",
  ...
  auction_com: "Auction.com foreclosure and REO listing signal lane",
  hubzu: "Hubzu foreclosure listing signal lane",
  xome: "Xome foreclosure and auction signal lane",
  attom_data: "ATTOM property and foreclosure data signal lane",
  ice_mortgage_tech: "ICE Mortgage Technology foreclosure and servicing signal lane",
  reox_directory: "REOX directory signal lane for REO agent and broker coverage",
  realtor_foreclosure: "Realtor.com foreclosure listing signal lane",
  redfin_foreclosure: "Redfin foreclosure listing signal lane",
  wells_fargo_reo: "Wells Fargo REO signal lane",
  chase_reo: "Chase REO signal lane",
  us_bank_reo: "US Bank REO signal lane",
  mr_cooper_reo: "Mr. Cooper listing and servicer signal lane",
  phh_mortgage_reo: "PHH Mortgage listing and servicer signal lane",
  newrez_shellpoint_reo: "NewRez / Shellpoint listing and servicer signal lane",
  selene_finance_reo: "Selene Finance listing and servicer signal lane",
  carrington_reo: "Carrington Mortgage listing and servicer signal lane",
  grok: "AI-assisted X search enrichment",
  reddit: "Community sentiment and discussion",
  news_api: "Live editorial headlines",
...
const SOURCE_LABELS: Record<string, string> = {
  ...
  google_jobs: "Google Jobs Signals",
  ziprecruiter_jobs: "ZipRecruiter Jobs",
  company_career_jobs: "Company Career Pages",
  ...
  hubzu: "Hubzu",
  xome: "Xome",
  attom_data: "ATTOM Data",
  ice_mortgage_tech: "ICE Mortgage Tech",
  reox_directory: "REOX Directory",
  realtor_foreclosure: "Realtor Foreclosures",
  redfin_foreclosure: "Redfin Foreclosures",
  wells_fargo_reo: "Wells Fargo REO",
  chase_reo: "Chase REO",
  us_bank_reo: "US Bank REO",
  mr_cooper_reo: "Mr. Cooper",
  phh_mortgage_reo: "PHH Mortgage",
  newrez_shellpoint_reo: "NewRez / Shellpoint",
  selene_finance_reo: "Selene Finance",
  carrington_reo: "Carrington Mortgage",
  grok: "Grok / X",
  reddit: "Reddit",
  news_api: "News API",
...
const SOURCE_EXTRACTION_DETAILS: Record<string, string> = {
  ...
  homepath:
    "Pulls Fannie Mae listing signals, titles, URLs, pricing, and sample property details when accessible.",
  zillow_rapidapi:
  ...
  google_jobs:
    "Pulls Google Jobs-style web search signals for REO and default servicing roles, including title, employer, and job URL.",
  ziprecruiter_jobs:
    "Pulls ZipRecruiter job signals for REO and servicing roles through public search indexing.",
  company_career_jobs:
    "Pulls hiring signals directly from bank and servicer career domains to capture early staffing activity.",
  usajobs_jobs:
  ...
  attom_data:
    "Pulls ATTOM property and foreclosure signal pages through public indexing, plus sample URLs and location evidence when available.",
  ice_mortgage_tech:
    "Pulls ICE Mortgage Technology foreclosure/default-servicing signal pages through public indexing, plus sample URLs.",
  reox_directory:
    "Pulls REOX directory signal pages and member references through public indexing, plus sample URLs.",
  realtor_foreclosure:
    "Pulls foreclosure listing signal counts from Realtor.com public web indexing, plus sample listing links.",
  redfin_foreclosure:
    "Pulls foreclosure listing signal counts from Redfin public web indexing, plus sample listing links.",
  wells_fargo_reo:
    "Pulls Wells Fargo REO signal links through public web indexing for foreclosure and bank-owned activity.",
  chase_reo:
    "Pulls Chase REO signal links through public web indexing for foreclosure and bank-owned activity.",
  us_bank_reo:
    "Pulls US Bank REO signal links through public web indexing for foreclosure and bank-owned activity.",
  mr_cooper_reo:
    "Pulls Mr. Cooper listing and servicing signal links through public web indexing for distressed activity.",
  phh_mortgage_reo:
    "Pulls PHH Mortgage listing and servicing signal links through public web indexing for distressed activity.",
  newrez_shellpoint_reo:
    "Pulls NewRez / Shellpoint listing and servicing signal links through public web indexing for distressed activity.",
  selene_finance_reo:
    "Pulls Selene Finance listing and servicing signal links through public web indexing for distressed activity.",
  carrington_reo:
    "Pulls Carrington Mortgage listing and servicing signal links through public web indexing for distressed activity.",
  zillow_research:
...
const SOURCE_GROUPS: Record<string, SourceGroup> = {
  ...
  google_jobs: "job_market",
  ziprecruiter_jobs: "job_market",
  company_career_jobs: "job_market",
  ...
  attom_data: "official_inventory",
  ice_mortgage_tech: "official_inventory",
  reox_directory: "official_inventory",
  realtor_foreclosure: "official_inventory",
  redfin_foreclosure: "official_inventory",
  wells_fargo_reo: "official_inventory",
  chase_reo: "official_inventory",
  us_bank_reo: "official_inventory",
  mr_cooper_reo: "official_inventory",
  phh_mortgage_reo: "official_inventory",
  newrez_shellpoint_reo: "official_inventory",
  selene_finance_reo: "official_inventory",
  carrington_reo: "official_inventory",
  news_api: "editorial",
  reddit: "community",
  grok: "ai_enrichment",
